...
input_data1 = open('A_med_run0Sc.dat', 'r')
input_data2 = open('A_med_run1Sc.dat', 'r')
input_data3 = open('A_med_run2Sc.dat', 'r')
input_data4 = open('A_med_run3Sc.dat', 'r')
input_data5 = open('A_med_run4Sc.dat', 'r')
