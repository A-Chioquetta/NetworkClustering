...
input_data1 = open('S1_run0Ct.dat', 'r')
input_data2 = open('S1_run1Ct.dat', 'r')
input_data3 = open('S1_run2Ct.dat', 'r')
input_data4 = open('S1_run3Ct.dat', 'r')
input_data5 = open('S1_run4Ct.dat', 'r')
...
for i in range(len(values1)):
    ...
    with open('S1_averagesCt.dat', 'a') as file:
