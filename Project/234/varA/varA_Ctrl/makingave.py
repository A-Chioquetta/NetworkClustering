...
input_data1 = open('varA_run0Ct.dat', 'r')
input_data2 = open('varA_run1Ct.dat', 'r')
input_data3 = open('varA_run2Ct.dat', 'r')
input_data4 = open('varA_run3Ct.dat', 'r')
input_data5 = open('varA_run4Ct.dat', 'r')
...
for i in range(len(values1)):
    ...
    with open('varA_averagesCt.dat', 'a') as file:
