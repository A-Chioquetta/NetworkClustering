...
input_data1 = open('S1_run0Sc.dat', 'r')
input_data2 = open('S1_run1Sc.dat', 'r')
input_data3 = open('S1_run2Sc.dat', 'r')
input_data4 = open('S1_run3Sc.dat', 'r')
input_data5 = open('S1_run4Sc.dat', 'r')
# input_data6 = open('S1_run6t.dat', 'r')
# input_data7 = open('S1_run7t.dat', 'r')
# input_data8 = open('S1_run8t.dat', 'r')
# input_data9 = open('S1_run9t.dat', 'r')
# input_data10 = open('S1_run10t.dat', 'r')
...
for i in range(len(values1)):
    ...
    with open('S1_averagesSc.dat', 'a') as file:
