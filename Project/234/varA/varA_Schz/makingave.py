...
input_data1 = open('varA_run0Sc.dat', 'r')
input_data2 = open('varA_run1Sc.dat', 'r')
input_data3 = open('varA_run2Sc.dat', 'r')
input_data4 = open('varA_run3Sc.dat', 'r')
input_data5 = open('varA_run4Sc.dat', 'r')
# input_data6 = open('varA_run6t.dat', 'r')
# input_data7 = open('varA_run7t.dat', 'r')
# input_data8 = open('varA_run8t.dat', 'r')
# input_data9 = open('varA_run9t.dat', 'r')
# input_data10 = open('varA_run10t.dat', 'r')
...
for i in range(len(values1)):
    ...
    with open('A_med_averagesSc.dat', 'a') as file:
